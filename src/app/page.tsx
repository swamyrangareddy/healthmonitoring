    ...
    <div className="relative isolate px-6 pt-14 lg:px-8 ">
      ...
      <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
        ...
        <div className="text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600">A Health Monitoring System (HMS) is a sophisticated technology and an alternative to the traditional management of patients and their health. It consists of a wearable wireless device like a bracelet with sensors that are paired with an application for a doctor to access the medical information.</p>
